...
void lustre_swab_obdo (struct obdo  *o)
{
	...
	lustre_swab_ost_id(&o->o_oi);
        ...
        /* we have to use the temp variable here because casting
         __swab64s (&o->o_sent_time.tv_sec);		 +           &o_sent_time.tv_sec to (__u64t*) would trigger a gcc warning on strict-
         __swab64s (&o->o_sent_time.tv_usec);		 +           aliasing 
         o_sent_time.tv_sec o_sent_time.tv_usec 为long long, __u64为unsigned long不能用上面的__swab64s
         */
